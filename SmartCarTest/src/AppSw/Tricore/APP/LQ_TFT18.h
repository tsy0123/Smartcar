...
#define LCD_WR_REG TFTSPI_Write_Cmd
#define LCD_WR_DATA8 TFTSPI_Write_Byte
#define LCD_WR_DATA TFTSPI_Write_Word
#define u8 uint8_t
#define u16 uint16_t
#define u32 uint32_t
/*!
...
void LCD_ShowPictureBin(u16 x,u16 y,u16 length,u16 width,const u8 pic[]);
